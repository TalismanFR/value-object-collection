...
namespace services\valueobjects\INN;


use InvalidArgumentException;
use services\valueobjects\common\ValueObject;

class Inn extends ValueObject implements \services\valueobjects\INN\contract\Inn
{
    /** @var string */
    private string $inn;
    ...
    private function setInn(string $inn): void
    {
        if ($this->isValid($inn)) {
            ...
            throw new InvalidArgumentException('INN is not valid');
        }
    }
